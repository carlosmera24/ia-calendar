...
-- -----------------------------------------------------
-- Data for table `permisions`
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (1, 'categories.index', 'Consultar categorías', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (2, 'categories.create', 'Crear categorías', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (3, 'categories.edit', 'Editar categorías', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (4, 'categories.delete', 'Eliminar categorías', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (5, 'categories.share', 'Compartir categorías', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (6, 'events.index', 'Consultar eventos', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (7, 'events.create', 'Crear eventos', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (8, 'events.edit', 'Editar eventos', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (9, 'events.delete', 'Eliminar eventos', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (10, 'events.share', 'Compartir eventos', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (11, 'categories.administrator.access', 'Acceso a categorías creadas por el administrador', DEFAULT, DEFAULT);
INSERT INTO `permisions` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (12, 'events.administrator.access', 'Acceso a eventos creados por el administrador', DEFAULT, DEFAULT);
