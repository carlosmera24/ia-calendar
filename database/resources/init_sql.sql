...
INSERT INTO `status_participants` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (2, 'Inactivo', 'Partícipe inhabilitado', DEFAULT, DEFAULT);
INSERT INTO `status_participants` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (3, 'Bloqueado', 'Partícipe bloqueado', DEFAULT, DEFAULT);
