...
INSERT INTO `status_users` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (5, 'Sin credenciales', 'Usuario con cambio de perfil a Invitado/Partícipe y no tiene acceso al sistema', DEFAULT, DEFAULT);
INSERT INTO `status_users` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (6, 'Eliminado', NULL, DEFAULT, DEFAULT);
