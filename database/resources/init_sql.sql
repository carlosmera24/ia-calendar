...
-- -----------------------------------------------------
-- Table `status_password_change_requests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `status_password_change_requests` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `description` TEXT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `password_change_requests` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `users_id` INT NOT NULL,
  `users_id_record` INT NOT NULL COMMENT 'User who registered the request',
  `status_password_change_requests_id` INT NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`, `users_id`, `users_id_record`, `status_password_change_requests_id`),
  CONSTRAINT `fk_password_change_requests_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_password_change_requests_users2`
    FOREIGN KEY (`users_id_record`)
    REFERENCES `users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_password_change_requests_status_password_change_requests1`
    FOREIGN KEY (`status_password_change_requests_id`)
    REFERENCES `status_password_change_requests` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_password_change_requests_users1_idx` ON `password_change_requests` (`users_id` ASC);

CREATE INDEX `fk_password_change_requests_users2_idx` ON `password_change_requests` (`users_id_record` ASC);

CREATE INDEX `fk_password_change_requests_status_password_change_requests_idx` ON `password_change_requests` (`status_password_change_requests_id` ASC);
...
-- -----------------------------------------------------
-- Data for table `status_password_change_requests`
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `status_password_change_requests` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (1, 'Activo', NULL, DEFAULT, DEFAULT);
INSERT INTO `status_password_change_requests` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (2, 'Expirado', NULL, DEFAULT, DEFAULT);
INSERT INTO `status_password_change_requests` (`id`, `name`, `description`, `created_at`, `updated_at`) VALUES (3, 'Finalizado', NULL, DEFAULT, DEFAULT);
